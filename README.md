...
3. Input is sent to Gemini LLM.
4. Model generates structured blog content.
5. Blog is displayed in the Streamlit application.
6. User can copy and use the generated content.
---
...
git clone https://github.com/saiteja-0518/FlavourFusion-RecipeMaster.git
cd FlavourFusion-RecipeMaster
...
## Conclusion
FlavourFusion successfully demonstrates the integration of Generative AI with web applications.
The system automates recipe blog creation using a Large Language Model (LLM), improving efficiency and creativity for users.
